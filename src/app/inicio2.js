export const inicio2 = (contenedor)=>{
    contenedor.innerHTML='';

    contenedor.innerHTML=`<div id="img-div">
    <img src="https://res.cloudinary.com/dbdrkxooj/image/upload/v1649797105/samples/workShop/Adoptado_szfntc.png" 
...
<div class="d-grid mb-1 p-3 gap-2">
    <form><button type="click" id="main" class="btn bg-black text-light text-center 
    rounded-pill" style="width: 60%; margin-left: 20vw;">siguiente</button></form>
</div>`;
}